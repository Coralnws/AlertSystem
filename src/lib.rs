...
#[derive(Debug)]
pub struct AlertSystemProcessor {
    verbose: bool,
    processed_count: usize,
}

impl AlertSystemProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting AlertSystem processing");
    
    let mut processor = AlertSystemProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = AlertSystemProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = AlertSystemProcessor::new(false);
